...
PRE_DEFINE_CATEGORIES = {"circle_1": 1, "circle_2": 2, "circle_3": 3, "circle_4": 4, "circle_5": 5, "circle_6": 6, "circle_7": 7, "circle_8": 8, "circle_9": 9,
                'bamboo_1': 10, 'bamboo_2': 11, 'bamboo_3': 12, 'bamboo_4': 13, 'bamboo_5': 14, 'bamboo_6': 15, 'bamboo_7': 16, 'bamboo_8': 17, 'bamboo_9': 18,
                ...
                'north': 28, 'south': 29, 'west': 30, 'east': 31, 'green': 32, 'red': 33, 'white': 34}
...
if __name__ == '__main__':
    ...
    xml_dir = os.path.join(root_path,'VOC2007_mahjong/Annotations') #已知的voc的标注
    ...
    for xml_file in xml_list:
        ...
        shutil.copy(os.path.join(root_path, 'VOC2007_mahjong/JPEGImages', img_name),
